<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logina.aspx.cs" Inherits="CalC.Login" %>
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <asp:Button ID="Button1" runat="server" Text="Login" class="btn girisBtn btn-md btn-block waves-effect waves-light text-center m-b-20" CssClass="auto-style1" OnClick="Button1_Click" />
                                        <br />
                                        <br />

                                        <div class>
                                            <asp:Label ID="Label1" runat="server" Text="Mail:user1@gmail.com"></asp:Label>
                                        </div>
                                        <div class>
                                            <asp:Label ID="Label2" runat="server" Text="Password:123456"></asp:Label>
                                        </div>
                                        <br />
                                        <br />
                                        <asp:Label ID="uyarimesaj" runat="server" Text=""></asp:Label>
                                    </div>
                                </div>
